...
<button
	...
	class="text-gray-500 dark:text-aqua hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5"
>
	{@html currentTheme === 'dark' ? svg.dark : svg.light}
</button>
